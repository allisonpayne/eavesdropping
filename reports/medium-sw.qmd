...
#added the figs part havent tried it yet, if it doesnt work thats why
map(1:length(bout_plots),
    ~ggsave(paste0("figs/comb_bouts/comb_bout_plot_", .x, ".png"),
            bout_plots[[.x]],
            width = 10,
            height = 3,
            units = "in"
...
Edited manual.csv to combine nearby bouts (within 30 mins of each other). What's up with the missing plots? need to investigate what is happening there.
