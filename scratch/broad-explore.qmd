...
Lower left corner: those points had odontocetes on preceding and subsequent days. This has removed the fact that this was a continuous process, so the relationship is lost. We need to model this as a temporal process, and also account for the fact that different odontocetes have different effects. To be continued!
